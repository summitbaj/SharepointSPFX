...
import styles from './RecentNotebookViewer.module.scss';
import { IRecentNotebookViewerProps } from './IRecentNotebookViewerProps';
import { escape } from '@microsoft/sp-lodash-subset';
import { SPHttpClient, SPHttpClientResponse } from '@microsoft/sp-http';

interface IRecentNotebookViewerState {
  latestFileUrl: string;
  linkingUrl: string;
}

export default class OneNoteLatestWebpart extends React.Component<IRecentNotebookViewerProps, IRecentNotebookViewerState> {

  constructor(props: IRecentNotebookViewerProps) {
    super(props);
  ...
  public render(): React.ReactElement<IRecentNotebookViewerProps> {
    const {
      description,
      imgSrc,
    } = this.props;
