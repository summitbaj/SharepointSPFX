...
import * as strings from 'OneNoteLatestWebPartStrings';
import OneNoteLatestWebpart from './components/OneNoteLatest';
import { IOneNoteLatestWebpartProps } from './components/IOneNoteLatestProps';
...
export default class OneNoteLatestWebPart extends BaseClientSideWebPart<IOneNoteLatestWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IOneNoteLatestWebpartProps> = React.createElement(
      OneNoteLatestWebpart,
      {
